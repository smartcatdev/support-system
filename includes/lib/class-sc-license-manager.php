<?php
/**
 * Provides common framework for managing extension updates and a license management page. This class has been forked
 * from OTS to provided extended support for the current admin menu configuration.
 *
 * @version 1.0.0
 * @since 1.5.0
 */

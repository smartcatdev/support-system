...
<div class="panel panel-default ticket-details" xmlns="http://www.w3.org/1999/html">
    <div class="panel-body">
        <p class="lead">
            <?php _e( in_array( $status, $statuses ) ? $statuses[ $status ] : $statuses['new'], Plugin::ID ); ?>
        </p>
        <p>
        ...
        <p>
            <?php _e( 'From ' . get_the_date( 'l F j, Y', $ticket ), Plugin::ID ); ?>
        </p>
    </div>
</div>
